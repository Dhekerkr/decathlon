...
export default function Qcm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const profile: SportProfile = {
      ...
      mainSport: answers.mainSport as string,
      goal: answers.goal as string,
      painZone: Array.isArray(answers.painZone)
        ? answers.painZone
        : [answers.painZone as string],
    };
    ...
    <div className="max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end pt-6">
          <button
            type="submit"
            className="group bg-blue-600 hover:bg-blue-700 text-white font-semibold px-8 py-4 rounded-xl shadow-lg flex items-center gap-2"
          >
            {Object.keys(answers).length === questions.length ? (
              <>
